$(function() {
	...
	$("ul.conditions li div.click-down").click(function(){
		...
		var old_height = $(this).parent("li").attr("data-old-height");
		if(is_open == 0){
			$(this).parent("li").css("height","auto");
		 	$(this).attr("is_open",1);
		}else{
			$(this).parent("li").css("height",old_height + "px");
		 	$(this).attr("is_open",0);
		}	
	})
	...
	$("#min_price,#max_price").focus(function(){
		$("ul.conditions li div.condition_value[data-screen-type='price'] a").removeClass("selected");
	})
	...
	$(".data-display-mode").click(function(){		
		...
		console.log(current_display_type);
