...
interface IConfig
{
     ...
     * @param unknown $pc            
     */
    function setLoginVerifyCodeConfig($instanceid, $platform, $admin, $pc, $error_num);
     ...
     */
    function getNoticeTemplateDetail($shop_id, $template_code, $notify_type);
    ...
    function updateConfigEnable($id, $is_use, $instanceid);
     ...
     * @param unknown $is_use            
     */
    function updateOrderExpressMessageConfig($shop_id, $appid, $appkey, $back_url, $is_use, $type, $customer);
     ...
     */
    function setIsEnableWapCustomTemplate($shop_id, $is_enable);
     ...
     * @param unknown $shop_id            
     */
    function getIsEnableWapCustomTemplate($shop_id);
