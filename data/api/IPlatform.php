...
interface IPlatform
{
     ...
     * @param unknown $image            
     */
    function updatePlatformDocument($id, $uid, $class_id, $title, $alt, $link_url, $is_visibility, $sort, $content, $image);
