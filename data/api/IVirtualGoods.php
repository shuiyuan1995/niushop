...
interface IVirtualGoods
{
     ...
     */
    function editVirtualGoodsType($virtual_goods_type_id, $virtual_goods_group_id, $validity_period, $confine_use_number, $value_info, $goods_id);
     ...
     * @param 创建时间 $create_time            
     */
    function addVirtualGoods($shop_id, $virtual_goods_name, $money, $buyer_id, $buyer_nickname, $order_goods_id, $order_no, $validity_period, $start_time, $end_time, $use_number, $confine_use_number, $use_status, $goods_id, $remark);
     ...
     */
    function updateVirtualGoods($virtual_goods_id, $virtual_goods_name, $money, $buyer_id, $buyer_nickname, $order_goods_id, $order_no, $start_time, $end_time);
    /**
     * 根据虚拟码删除虚拟商品
     *
     * @param 虚拟码 $virtual_code            
     ...
     * @param string $condition
     */
    function getVirtualGoodsGroup($condition = "");
    
    /**
     * 获取虚拟商品分组详情
     * @param unknown $virtual_goods_group_id
     */
    function getVirtualGoodsGroupInfo($virtual_goods_group_id);
     ...
     */
    function addBatchVirtualCard($virtual_goods_type_id, $goods_id, $virtual_card_json);
     ...
     * @param unknown $virtual_goods_type_id
     */
    function setVirtualCardByGoodsStock($goods_id);
}