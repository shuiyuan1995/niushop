...
class NfxUser extends BaseService implements INfxUser
{
     ...
     */
    public function userAssociateShop($uid, $shop_id, $session_id)
    {
...
//                     $unify = new UnifyPay();
//                     $wechat_retval = $unify->wechatTransfers($openid, $user_commission_withdraw_info["withdraw_no"], $transfer_money * 100, realname, $transfer_remark);
                    $transfer_result = '';
