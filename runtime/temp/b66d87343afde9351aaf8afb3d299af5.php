<?php if (!defined('THINK_PATH')) exit(); /*a:16:{s:43:"template/shop\blue\Goods\promotionZone.html";i:1553151902;s:28:"template/shop\blue\base.html";i:1553151902;s:32:"template/shop\blue\urlModel.html";i:1553151902;s:34:"template/shop\blue\controlTop.html";i:1553157362;s:41:"template/shop\blue\controlHeadSerach.html";i:1553151902;s:43:"template/shop\blue\controlHeadGoodType.html";i:1553151902;s:40:"template/shop\blue\controlCommonNav.html";i:1553151902;s:43:"template/shop\blue\controlRightSidebar.html";i:1553151902;s:40:"template/shop\blue\controlBrandSale.html";i:1553151902;s:41:"template/shop\blue\controlCommonPage.html";i:1553151902;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1553151902;s:59:"template/shop\blue\Goods\controlPopUpGoodsSkuAttribute.html";i:1553151902;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1553507716;s:37:"template/shop\blue\controlBottom.html";i:1553151902;s:36:"template/shop\blue\controlLogin.html";i:1553151902;s:37:"template/shop\blue\baidu_js_push.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- 内容 -->
	...
	<?php $service = new data\service\Platform;$advlist = $service->getPlatformAdvPositionDetail("6666", "*");$advlist = json_encode($advlist);$advlist = json_decode($advlist, ture); if(!(empty($advlist['adv_list']) || (($advlist['adv_list'] instanceof \think\Collection || $advlist['adv_list'] instanceof \think\Paginator ) && $advlist['adv_list']->isEmpty()))): ?>
	<div class="banner">
		<ul class="full-screen-slides" id="fullScreenSlides" >
			<?php if(is_array($advlist['adv_list']) || $advlist['adv_list'] instanceof \think\Collection || $advlist['adv_list'] instanceof \think\Paginator): if( count($advlist['adv_list'])==0 ) : echo "" ;else: foreach($advlist['adv_list'] as $k=>$vo): if($k == 0): ?>
					<li style="background:<?php echo $vo['background']; ?> url(<?php echo __IMG($vo['adv_image']); ?>) no-repeat 50% 50%;"><a href="<?php echo __URL($vo['adv_url']); ?>" target="_blank" title="">&nbsp;</a></li>
				<?php else: ?>
					<li style="display: none;background:<?php echo $vo['background']; ?> url(<?php echo __IMG($vo['adv_image']); ?>) no-repeat 50% 50% ;"><a href="<?php echo __URL($vo['adv_url']); ?>" target="_blank" title="">&nbsp;</a> </li>
				<?php endif; endforeach; endif; else: echo "" ;endif; ?>
		</ul>
		<ul class="full-screen-slides-pagination" style="height:0px;">
			<?php if(is_array($advlist['adv_list']) || $advlist['adv_list'] instanceof \think\Collection || $advlist['adv_list'] instanceof \think\Paginator): $k = 0; $__LIST__ = $advlist['adv_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($k == 1): ?>
	...
	<div class="w1210">
		<div class="sale-container">
			<!-- 促销类别列表 -->
			<?php if(!(empty($groupList) || (($groupList instanceof \think\Collection || $groupList instanceof \think\Paginator ) && $groupList->isEmpty()))): ?>
					...
					<div class="pinpaijngxuan_pro_title">
						<div class="brand-showcase-list" id="brand-list">
							<ul style="width: 1092px; position: relative; height: 100%;">
								<?php if(is_array($groupList) || $groupList instanceof \think\Collection || $groupList instanceof \think\Paginator): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;if($type['group_id'] == $group_id): ?>
								<li class="current">
								<?php else: ?>
								<li>
								<?php endif; ?>
									<a href="javascript:categoryHref(<?php echo $type['group_id']; ?>);" title="<?php echo $type['group_name']; ?>" id="<?php echo $type['group_id']; ?>"><?php echo $type['group_name']; ?></a>
								</li>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
			...
			<?php endif; ?>
			<div class="wrapper">
				<?php if(!(empty($goods_list['data']) || (($goods_list['data'] instanceof \think\Collection || $goods_list['data'] instanceof \think\Paginator ) && $goods_list['data']->isEmpty()))): ?>
				<ul class="list-grid clearfix js-list-grid">
					...
					<li class="item <?php if($k != 0 && ($k+1)%5==0): ?>last<?php endif; ?>">
						<div class="item-con">
							<div class="item-pic">
							...
							<?php if(!(empty($curr_group['group_id']) || (($curr_group['group_id'] instanceof \think\Collection || $curr_group['group_id'] instanceof \think\Paginator ) && $curr_group['group_id']->isEmpty()))): ?>
							<div class="tag-small-block" style="overflow: hidden;">
								<?php if($curr_group['picture']['pic_cover']!=''): ?>
								<img src="<?php echo __IMG($curr_group['picture']['pic_cover']); ?>"/>
								<?php else: ?>
								<img src="__TEMP__/<?php echo $style; ?>/public/images/merchandising_label.png"/>
								<span><?php echo $curr_group['group_name']; ?></span>
								<?php endif; ?>
							</div>
							<?php endif; ?>
							<div class="item-info">
								...
								<div class="item-con-info">
									<div class="fr" style="float: left;margin-right: 5px;">
										...
										<?php if(in_array(($goods['point_exchange_type']), explode(',',"0,2"))): if($goods['goods_type'] == 1): if($goods['is_open_presell'] == 0): ?>
													<!-- 实物商品 -->
									...
									<div class="fl">
										<div class="item-operate <?php if($goods['is_favorite']>0): ?>is_favorite<?php endif; ?>">
												...
												<span style="display: inline;"> <?php if($goods['is_favorite']>0): ?><?php echo lang('goods_collected'); else: ?><?php echo lang('goods_collection'); endif; ?>
							 					</span>
											</a>
				...
				<div class="tip-box" style="position: static;">
					<i class="tip-icon"></i>
					<div class="tip-text"><?php echo lang('sorry'); ?>！<?php echo lang('no_result_you_want'); ?>……</div>
				</div>
				<?php endif; ?>
			</div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_11713__=1;$__FOR_END_11713__=$page_count+1;for($i=$__FOR_START_11713__;$i < $__FOR_END_11713__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_24232__=1;$__FOR_END_24232__=$page_num+1;for($i=$__FOR_START_24232__;$i < $__FOR_END_24232__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_14027__=$page_count-$page_num+1;$__FOR_END_14027__=$page_count+1;for($i=$__FOR_START_14027__;$i < $__FOR_END_14027__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_7578__=$page-($page_num-1)/2;$__FOR_END_7578__=$page+($page_num-1)/2+1;for($i=$__FOR_START_7578__;$i < $__FOR_END_7578__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
