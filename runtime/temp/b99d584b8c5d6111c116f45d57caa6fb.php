<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:43:"template/shop\blue\Member\seeLogistics.html";i:1554176224;s:28:"template/shop\blue\base.html";i:1554176224;s:32:"template/shop\blue\urlModel.html";i:1554176224;s:34:"template/shop\blue\controlTop.html";i:1554176224;s:41:"template/shop\blue\controlHeadSerach.html";i:1554176224;s:43:"template/shop\blue\controlHeadGoodType.html";i:1554176224;s:40:"template/shop\blue\controlCommonNav.html";i:1554176224;s:43:"template/shop\blue\controlRightSidebar.html";i:1554176224;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1554176224;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1554176224;s:37:"template/shop\blue\controlBottom.html";i:1554176224;s:36:"template/shop\blue\controlLogin.html";i:1554176224;s:37:"template/shop\blue\baidu_js_push.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="__TEMP__/<?php echo $style; ?>/public/css/seeLogistics.css">
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			...
			<?php if(is_array($order['goods_packet_list']) || $order['goods_packet_list'] instanceof \think\Collection || $order['goods_packet_list'] instanceof \think\Paginator): if( count($order['goods_packet_list'])==0 ) : echo "" ;else: foreach($order['goods_packet_list'] as $k=>$vo): ?>
			<div class="package-info" express-id="<?php echo $vo['express_id']; ?>">
				<div class="tit-wrap">
					<ul class="package">
						<li><?php echo $vo['packet_name']; ?></li>
						<span class="sepa"></span>
						<li>物流公司：<?php echo $vo['express_name']; ?></li>
						<span class="sepa"></span>
						<li>快递单号：<?php echo $vo['express_code']; ?></li>
						<li><a href="javascript:;" <?php if($k == 0): ?>class="open"<?php endif; ?>>查看物流<i class="icon-triangle"></i></a></li>
					</ul>
				</div>	
				<div class="logistics-trace" <?php if($k > 0): ?> style="display:none;" <?php endif; ?>>
					<ul>
			...
			<div class="order-info">
				<div class="left-container">
					<dl>
						<dt><?php echo lang('member_order_number'); ?>：</dt>
						<dd><?php echo $order['order_no']; ?></dd>
					</dl>
					<dl>
						<dt><?php echo lang('member_order_status'); ?>：</dt>
						<dd><?php echo $order['status_name']; ?></dd>
					</dl>
					<dl>
						<dt><?php echo lang('member_payment_method'); ?>：</dt>
						<dd><?php echo $order['payment_type_name']; ?></dd>
					</dl>
					<dl>
						<dt><?php echo lang('member_payment_status'); ?>：</dt>
						<dd><?php echo $order['pay_status_name']; ?></dd>
					</dl>
					<dl>
						<dt><?php echo lang('member_delivery_mode'); ?>：</dt>
						<dd><?php echo $order['shipping_type_name']; ?>&nbsp;&nbsp;<?php echo $order['shipping_company_name']; ?></dd>
					</dl>
					<?php switch($order['shipping_type']): case "1":case "3": ?>
						<dl>
							<dt><?php echo lang('member_receiving_information'); ?>：</dt>
							<dd><?php echo $order['receiver_name']; ?>，<?php echo $order['receiver_mobile']; ?>，<?php if(!(empty($order['fixed_telephone']) || (($order['fixed_telephone'] instanceof \think\Collection || $order['fixed_telephone'] instanceof \think\Paginator ) && $order['fixed_telephone']->isEmpty()))): ?><?php echo $order['fixed_telephone']; ?>，<?php endif; ?> <?php echo $order['address']; if($order['receiver_zip']!=''): ?>，<?php echo $order['receiver_zip']; endif; ?></dd>
						</dl>
						<?php break; case "2": ?>
						<dl>
							<dt><?php echo lang('member_self_addressed_address'); ?>：</dt>
							<dd><?php echo $order['order_pickup']['province_name']; ?>&nbsp;<?php echo $order['order_pickup']['city_name']; ?>&nbsp;<?php echo $order['order_pickup']['district_name']; ?>&nbsp;<?php echo $order['order_pickup']['address']; ?></dd>
						</dl>
						<?php break; endswitch; ?>
				</div>
