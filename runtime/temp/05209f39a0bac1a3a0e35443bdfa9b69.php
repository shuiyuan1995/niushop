<?php if (!defined('THINK_PATH')) exit(); /*a:12:{s:44:"template/shop\blue\Member\addressInsert.html";i:1554174369;s:28:"template/shop\blue\base.html";i:1553151902;s:32:"template/shop\blue\urlModel.html";i:1553151902;s:34:"template/shop\blue\controlTop.html";i:1553157362;s:41:"template/shop\blue\controlHeadSerach.html";i:1553151902;s:43:"template/shop\blue\controlHeadGoodType.html";i:1553151902;s:40:"template/shop\blue\controlCommonNav.html";i:1553151902;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1553151902;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1553507716;s:37:"template/shop\blue\controlBottom.html";i:1553151902;s:36:"template/shop\blue\controlLogin.html";i:1553151902;s:37:"template/shop\blue\baidu_js_push.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="first active"><?php echo lang('member_new_delivery_address'); ?></li>
				</ul>
			</div>
			...
			<input type="hidden" id="adressid" value="<?php echo $address_id; ?>" />
			...
			<form action="" method="post" name="theForm">
				<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee">
					<tr>
						<td align="right" width="10%"><?php echo lang('member_distribution_area'); ?>：</td>
						<td colspan="3" align="left">
							...
							(<?php echo lang('member_required'); ?>)
						</td>
					</tr>
					<tr>
						<td align="right" width="10%"><?php echo lang('member_consignee_name'); ?>：</td>
						<td align="left" width="40%"><input name="consignee" type="text" class="inputBg" id="Name" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right"><?php echo lang('member_detailed_address'); ?>：</td>
						<td align="left" colspan="3"><input name="address" type="text" class="inputBg" id="AddressInfo" style="width: 692px;"/>(<?php echo lang('member_required'); ?>)</td>
					</tr>
					<tr>
						<td align="right"><?php echo lang('member_phone'); ?>：</td>
						<td align="left"><input name="mobile" type="text" class="inputBg" id="Moblie" />(<?php echo lang('member_required'); ?>)</td>
					</tr>
					<tr>
						<td align="right"><?php echo lang('member_fixed_telephone'); ?>：</td>
						<td align="left"><input type="text" class="inputBg" id="phone" value="" /></td>
					</tr>
					<tr>
						<td colspan="4" align="center"><input type="button" name="button" class="common-btn"  value="<?php echo lang('member_new_delivery_address'); ?>" onclick="saveAddress()"/></td>
					</tr>
				</table>
			</form>
...
$(function() {
	...
	$("li[data-href^='<?php echo __URL('SHOP_MAIN/member/addresslist'); ?>']").addClass('current');
	$(".js-bread-crumb").attr("href",__URL('SHOP_MAIN/member/addresslist'));
	$(".js-bread-crumb").text("<?php echo lang('member_delivery_address'); ?>");
	$(".js-bread-crumb").parent().append('<span class="crumbs-arrow">&gt;</span><a href="<?php echo __URL('SHOP_MAIN/member/addressinsert'); ?>"><?php echo lang('member_add_delivery_address'); ?></a>');
	
	var selCity = $("#seleAreaNext")[0];
	for (var i = selCity.length - 1; i >= 0; i--) {
		selCity.options[i] = null;
	}
	var opt = new Option("<?php echo lang('member_select_province'); ?>", "-1");
	...
	if (address_id != 0) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				var opt = new Option("<?php echo lang('member_select_city'); ?>", "-1");
				selCity.options.add(opt);
				$.ajax({
					type : "post",
