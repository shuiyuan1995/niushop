<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Wchat\keyConcernConfig.html";i:1554176224;s:28:"template/adminblue\base.html";i:1554365531;s:45:"template/adminblue\controlCommonVariable.html";i:1554176224;s:32:"template/adminblue\urlModel.html";i:1554176224;s:34:"template/adminblue\pageCommon.html";i:1554176224;s:34:"template/adminblue\openDialog.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>是否首页显示:</dt>
		<dd>
			<input type="checkbox" class="checkbox" name="is_show_follow" <?php if($website_info['is_show_follow']): ?> checked="checked" <?php endif; ?>/>
		</dd>
	</dl>
...
function setConfigAjax() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/wchat/keyConcernConfig'); ?>",
		data : { 'is_show_follow' : is_show_follow },
		success : function(data) {
			if (data["code"] > 0) {
				showTip(data['message'],'success');
				location.href = "<?php echo __URL('ADMIN_MAIN/wchat/keyConcernConfig'); ?>";
			} else {
