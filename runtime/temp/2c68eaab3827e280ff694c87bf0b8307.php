<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:35:"template/shop\blue\Index\index.html";i:1555056154;s:28:"template/shop\blue\base.html";i:1555056154;s:32:"template/shop\blue\urlModel.html";i:1555056154;s:43:"template/shop\blue\Index\controlHeadAd.html";i:1555056154;s:34:"template/shop\blue\controlTop.html";i:1555056154;s:41:"template/shop\blue\controlHeadSerach.html";i:1555056154;s:43:"template/shop\blue\controlHeadGoodType.html";i:1555056154;s:40:"template/shop\blue\controlCommonNav.html";i:1555056154;s:44:"template/shop\blue\Index\controlHeadNav.html";i:1555056154;s:49:"template/shop\blue\Index\controlHeadNavRight.html";i:1555056154;s:43:"template/shop\blue\controlRightSidebar.html";i:1555056154;s:45:"template/shop\blue\Index\controlIndexAdv.html";i:1555056154;s:56:"template/shop\blue\Index\controlLimitedTimeDiscount.html";i:1555056154;s:49:"template/shop\blue\Index\controlCommendBlock.html";i:1555056154;s:45:"template/shop\blue\Index\controlRecFloor.html";i:1555056154;s:51:"template/shop\blue\Index\controlFriendshipLink.html";i:1555056154;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1555056154;s:37:"template/shop\blue\controlBottom.html";i:1555056154;s:36:"template/shop\blue\controlLogin.html";i:1555056154;s:37:"template/shop\blue\baidu_js_push.html";i:1555056154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
	...
	.selectgoods .goodslist{width: 302px !important;margin-right: 0px;border: none !important;position: relative;}
	.selectgoods .goodslist::after{position: absolute;top: 5%;right: 0px;content: '';height: 90%;width: 4px;background: #e5e5e5;}
	.selectgoods .goodslist:nth-of-type(4n+1)::before{position: absolute;top: 0;left: 0;content: '';width: 400%;border-top: 5px solid #e5e5e5;z-index: 1;}
	.selectgoods .goodslist:nth-of-type(4n+4)::after,
	.selectgoods .goodslist:last-of-type::after{display: none;}
	.selectgoods .goodslist:nth-of-type(9),
	.selectgoods .goodslist:nth-of-type(10){width: 605px !important;height: 234px;padding-top: 34px;background: #f6f6f6;box-sizing: border-box;}
	.selectgoods .goodslist:nth-of-type(9) .goods-list-padding-block,
	.selectgoods .goodslist:nth-of-type(10) .goods-list-padding-block{width: 531px;height: 165px;background: #ffffff url(/template/shop/blue/public/images/item_bg.png) no-repeat 12px 8px;background-size: 58px 58px;box-sizing: border-box;padding: 2px 0 4px;}
	...
	.selectgoods .goodslist:nth-of-type(10)::before{display: none;}
	.selectgoods .goodslist:nth-of-type(9) .goods_img,
	.selectgoods .goodslist:nth-of-type(10) .goods_img{float: left;height: 100%;margin-left: 88px;}
	.selectgoods .goodslist:nth-of-type(9) .goods_name,
	.selectgoods .goodslist:nth-of-type(10) .goods_name{margin-top: 7px;}
	.selectgoods .goodslist:nth-of-type(9) .goods_name,
	...
	.selectgoods .goodslist:nth-of-type(10) .goods_add{display: inline-block;width: 50%;text-align: left;padding-left: 10px;padding-right: 5px;}
	.selectgoods .goodslist:nth-of-type(n+11){width: 274px !important;height: 349px;border-radius: 5px;border: solid 2px #eeeeee !important;margin-right: 32px;}
	.selectgoods .goodslist:nth-of-type(n+11)::after,
	.selectgoods .goodslist:nth-of-type(n+11)::before{display: none;}
	</style>
	<!-- 首页楼层开始 -->
	<script>
	//移入事件
	...
	<!-- 新品：newgoods -->
	    <?php if($vo['id']==1): ?>
	<div class="w1210 floor-list newgoods" onmouseleave ="levelGoodsList(this)">
		<?php else: ?>
							...
							<?php foreach($vo['goods_list'] as $k=>$v): if($k < $vo['goods_num']): if($k == (count($vo['goods_list'])-1) && ($k+1) != $vo['goods_num'] && ($k+1) != ($vo['goods_num']/2)): ?>
								...
								<div class="goods-list-padding-block">
									...
									<?php else: if($v['point_exchange_type'] == 1 && $v['promotion_price'] > 0): ?>
										...
										<?php endif; endif; ?>
									<div class="goods_add">
										<a href="<?php echo __URL('SHOP_MAIN/goods/addCart','goods_id='.$v['goods_id']&'goods_name='.$v['goods_name']); ?>">
