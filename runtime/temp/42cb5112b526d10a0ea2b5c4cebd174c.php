<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:48:"template/wap\default_new\Order\paymentOrder.html";i:1553151902;s:34:"template/wap\default_new\base.html";i:1553151902;s:38:"template/wap\default_new\urlModel.html";i:1553151903;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="order-total-pay bottom-fix">
	<div class="pay-container clearfix">
		...
		<input type="hidden" id="distribution_time_out" value='<?php echo $distribution_time_out; ?>'>
	</div>
</div>
	...
	<div class="list">
		<ul>
			...
			<li class="item <?php if($k==0): ?>active<?php endif; ?>" data-id="<?php echo $pickup['id']; ?>">
				<div class="check-img"></div>
				<div class="single"><?php echo $pickup['province_name']; ?>&nbsp;<?php echo $pickup['city_name']; ?>&nbsp;<?php echo $pickup['district_name']; ?>&nbsp;<?php echo $pickup['address']; ?></div>
			</li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
