<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:39:"template/adminblue\Goods\editGoods.html";i:1554176224;s:28:"template/adminblue\base.html";i:1554365531;s:45:"template/adminblue\controlCommonVariable.html";i:1554176224;s:61:"template/adminblue\Goods\controlEditGoodsCommonResources.html";i:1554176224;s:32:"template/adminblue\urlModel.html";i:1554176224;s:49:"template/adminblue\Goods\controlGoodsPresell.html";i:1554176224;s:42:"template/adminblue\Goods\fileAlbumImg.html";i:1554176224;s:58:"template/adminblue\Goods\controlEditGoodsCommonScript.html";i:1554176224;s:34:"template/adminblue\pageCommon.html";i:1554176224;s:34:"template/adminblue\openDialog.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<div class="block-basic-setting">
			...
			<dd id ="extend_name_category_box">
				<?php if($goods_info): ?>
					...
					<?php if(!empty($goods_info['extend_category'])): foreach($goods_info["extend_category"] as $k=>$vo): ?>
						<div class="extend-name-category" id="extend_name_category<?php echo $k; ?>" data-flag="extend_category" data-goods-id="<?php echo $goods_id; ?>" cid="<?php echo $vo['extend_category_id']; ?>" data-attr-id="<?php echo $goods_info['goods_attribute_id']; ?>" cname="<?php echo $vo['extend_category_name']; ?>">
		...
		<dl class="js-virtual-goods-point-card-inventory">
			...
			<dd>
				...
				<textarea class="textarea-common long" id="card_password"></textarea>
			</dd>
		</dl>
			...
			<dl>
				...
				<dd>
					<label class="radio inline normal decimal_reservation_number">
						<i class="checkbox-common <?php if($level_list[0]['decimal_reservation_number'] == 0): ?>selected<?php endif; ?>">
							<input type="checkbox" name="decimal-reservation-number" value="0" <?php if($level_list[0]['decimal_reservation_number'] == 0): ?>checked<?php endif; ?>>
						</i>
						<span>抹去角和分</span>
					</label>
					<label class="radio inline normal decimal_reservation_number">
						<i class="checkbox-common <?php if($level_list[0]['decimal_reservation_number'] == 1): ?>selected<?php endif; ?>">
							<input type="checkbox" name="decimal-reservation-number" value="1" <?php if($level_list[0]['decimal_reservation_number'] == 1): ?>checked<?php endif; ?>>
						</i>
						<span>抹去分</span>
					</label>
				</dd>
...
<!-- 			（第一张图片将作为商品主图，支持同时上传多张图片,多张图片之间可随意调整位置；支持jpg、gif、png格式上传或从图片空间中选择，建议使用尺寸800x800像素以上、大小不超过1M的正方形图片，上传后的图片将会自动保存在图片空间的默认分类中。） -->
		...
		<div class="goods-sku-picture">
			<h4>规格图片</h4>
			<dl class="sku-picture-dl" <?php if($goods_info && $goods_info['goods_spec_format'] !=''): ?>style="display:block;"<?php endif; ?>>
				<dt>规格名列表：</dt>
				<dd>
...
<?php endif; ?>
<script>
var specObjStr = StringTransference('<?php echo $goods_info['goods_spec_format']; ?>', {" " : "&nbsp;"});
