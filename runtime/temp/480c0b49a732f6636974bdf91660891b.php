<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"template/adminblue\System\dialogAlbumList.html";i:1554176224;s:45:"template/adminblue\controlCommonVariable.html";i:1554176224;s:34:"template/adminblue\pageCommon.html";i:1554176224;}*/ ?>
<html>
	<head>
		...
		*/
		...
		function imgUpload(){
			...
			$('#fileupload').fileupload({
				...
				dataType: 'json',
				formData:{"album_id" : $("#album_list li[class='select_type']").attr("data-album_id"),"type" : "1,2,3,4",'file_path' : "<?php echo $upload_path; ?>"},
				add: function (e,data) {
					//显示上传图片框
					if($("#uploader").is(":hidden")){
						$("#uploader").show();
