						...
						<table cellpadding="10" width="600px">
							<tr>
								...
								<td width="65%" align="left">
									<?php if($member_detail['user_info']['user_headimg'] != '' and $member_detail['user_info']['user_headimg'] != '0'): ?>
									<img src="<?php echo __IMG($default_headimg); ?>" class="lazy_load" data-original="<?php echo __IMG($member_detail['user_info']['user_headimg']); ?>" onClick="setTabCatGoods('tab',2,3)"/>
									<?php else: ?>
							...
							<tr>
								...
								<td width="65%" align="left">
									<input type="text" name="user_name" value="<?php echo $member_detail['user_info']['nick_name']; ?>" size="25" class="inputBg" style="ime-mode:disabled" />
							...
							<tr>
								...
								<td width="65%" align="left">
									<input type="text" name="real_name" value="<?php echo $member_detail['user_info']['real_name']; ?>" size="25" class="inputBg" style="ime-mode:disabled" />
							...
							<tr>
								...
								<td width="65%" align="left">
									<input type="date" name="birthday" value="<?php echo $member_detail['user_info']['birthday']; ?>" size="25" class="inputBg" style="ime-mode:disabled" />
							...
							<tr>
								...
								<td width="65%" align="left">
									<input type="text" name="location" value="<?php echo $member_detail['user_info']['location']; ?>" size="25" class="inputBg" style="ime-mode:disabled" />
							...
							<tr>
								...
								<td width="65%" align="left">
									<input type="number" name="user_qq" value="<?php echo $member_detail['user_info']['user_qq']; ?>" size="25" class="inputBg" style="ime-mode:disabled" />
							...
							<tr>
								<td colspan="2" align="center">
									<div class="img" id="preview">
										<?php if($member_detail['user_info']['user_headimg'] != '' and $member_detail['user_info']['user_headimg'] != '0'): ?>
										<img src="<?php echo __IMG($default_headimg); ?>" id="imguser_headimg" class="lazy_load" data-original="<?php echo __IMG($member_detail['user_info']['user_headimg']); ?>" width="120px" height="120px"/>
										<?php else: ?>
										<img width="120px" height="120px" id="imguser_headimg" src="<?php echo __IMG($default_headimg); ?>" />
										<?php endif; ?>
									</div>
								</td>
							</tr>
									...
									<div class="ncm-upload-btn">
										<a href="javascript:void(0);">
											<span>
												...
												<input type="hidden" id="user_headimg" value="<?php echo $member_detail['user_info']['user_headimg']; ?>" />
											</span>
										</a>
									</div>
								</td>
							...
							<tr>
								<td colspan="2" align="center">
									<label class="submit-border">
										...
										<input name="submit2" type="submit" class="common-btn main-btn" onclick="saveImage()" value="<?php echo lang('member_confirm_change'); ?>" />
									</label>
								</td>
							</tr>
						</table>
...
function saveImage(){
	$.ajax({
		url : "<?php echo __URL('SHOP_MAIN/member/person'); ?>",
		type : "post",
...
$(document).ready(function(){
	...
	var sex = "<?php echo $member_detail['user_info']['sex']; ?>";
	if(sex == 1){
