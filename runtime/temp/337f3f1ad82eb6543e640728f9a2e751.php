<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"template/wap\default_new\Order\orderDetail.html";i:1553151902;s:34:"template/wap\default_new\base.html";i:1553151902;s:38:"template/wap\default_new\urlModel.html";i:1553151903;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="order-detail-sum clear">
			<div class="sum-r order-detail-r">
				<ul class="sum-r-ul">
					...
					<li><span class="label"><?php echo lang('delivery_time'); ?>：</span><span class="value"><?php if($order['shipping_time']>0): ?><?php echo getTimeStampTurnTimeByYmd($order['shipping_time']); ?> <?php echo $order['distribution_time_out']; else: ?><?php echo lang('days_and_holidays_can_be_delivered'); endif; ?></span></li>
				</ul>
			</div>
		</div>
	</section>
				...
				<ul class="address-r-ul">
					<?php switch($order['shipping_type']): case "1":case "3": ?>
						...
						<li class="name">
							...
							<span class="value"><?php echo $order['order_pickup']['province_name']; ?>&nbsp;<?php echo $order['order_pickup']['city_name']; ?>&nbsp;<?php echo $order['order_pickup']['district_name']; ?>&nbsp;<?php echo $order['order_pickup']['address']; ?></span>
						</li>
