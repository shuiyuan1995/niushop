<?php if (!defined('THINK_PATH')) exit(); /*a:14:{s:40:"template/shop\blue\Member\orderList.html";i:1554176224;s:28:"template/shop\blue\base.html";i:1554176224;s:32:"template/shop\blue\urlModel.html";i:1554176224;s:34:"template/shop\blue\controlTop.html";i:1554176224;s:41:"template/shop\blue\controlHeadSerach.html";i:1554176224;s:43:"template/shop\blue\controlHeadGoodType.html";i:1554176224;s:40:"template/shop\blue\controlCommonNav.html";i:1554176224;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1554176224;s:41:"template/shop\blue\controlCommonPage.html";i:1554176224;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1554176224;s:37:"template/shop\blue\controlBottom.html";i:1554176224;s:34:"template/shop\blue\openDialog.html";i:1554176224;s:36:"template/shop\blue\controlLogin.html";i:1554176224;s:37:"template/shop\blue\baidu_js_push.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<tbody id="list_content" class="close-order">
					...
					<tr class="order-bd">
						<td align="center" class="baobei no-border-right order_goods_info">
							...
							<?php if($order_item['gift_flag'] > 0): ?>
							<i style="font-size:12px;margin: 0 5px 0 65px;padding:1px 4px;border-radius:3px;display: inline-block;color:#FFF;background-color:#de533c;height:16px;line-height: 16px;overflow:hidden;font-style:normal;float: left;">赠品</i>
							<?php endif; ?>
						</td>
						...
						<td align="center" class="baobei no-border-right order_goods_info" style="padding:0;"><div class="goods_desc price  last" style="padding-left:0px; line-height:50px;"> ￥<?php echo $order_item['price']; ?> </div></td>
						<td align="center" class="baobei no-border-right order_goods_info" style="padding:0;"><div class="goods_desc last" style="padding-left:0px;line-height:50px;"> <?php echo $order_item['num']; ?> </div> </td>
						<td align="center" class="after-service baobei no-border-right order_goods_info" valign="middle">
							<div class="goods_desc last">
								<?php if($order_item['gift_flag'] == 0): if($order['payment_type'] == 4): if($order['is_refund'] == 1 AND $order_item['refund_status'] == 0 AND $order['order_status'] == 2): ?>
										...
										<?php endif; endif; endif; if($order['order_status'] == 4  && $order_item['customer_info'] == ''): if(($order['finish_time'] + $shou_array['shou_time']) > $shou_array['time'] || $shou_array['shouhou'] == 0): ?>
										<div><a href="<?php echo __URL('SHOP_MAIN/member/customerService','order_goods_id='.$order_item['order_goods_id']); ?>"  style="border: 1px solid #0689e1;padding: 3px 8px;color: #0689e1;line-height: 45px;">申请售后</a></div>
									<?php endif; elseif($order['order_status'] == 4  && $order_item['customer_info'] != ''): ?>
								<div><a href="<?php echo __URL('SHOP_MAIN/member/customerService','order_goods_id='.$order_item['order_goods_id']); ?>"  style="border: 1px solid #0689e1;padding: 3px 8px;color: #0689e1;line-height: 45px;">查看售后</a></div>
								<?php endif; endif; ?>
							</div>
						</td>
						<?php if($k == 1): ?>
						...
						<td rowspan="<?php echo count($order['order_item_list']); ?>" align="center" class="trade-status no-border-right">
							...
							<a href="<?php echo __URL('SHOP_MAIN/member/seeLogistics','orderid='.$order['order_id']); ?>" class="main-color"><?php echo lang('member_view_logistics'); ?></a>
						<?php endif; ?>
						</td>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_23799__=1;$__FOR_END_23799__=$page_count+1;for($i=$__FOR_START_23799__;$i < $__FOR_END_23799__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_4342__=1;$__FOR_END_4342__=$page_num+1;for($i=$__FOR_START_4342__;$i < $__FOR_END_4342__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_10641__=$page_count-$page_num+1;$__FOR_END_10641__=$page_count+1;for($i=$__FOR_START_10641__;$i < $__FOR_END_10641__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_10168__=$page-($page_num-1)/2;$__FOR_END_10168__=$page+($page_num-1)/2+1;for($i=$__FOR_START_10168__;$i < $__FOR_END_10168__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
