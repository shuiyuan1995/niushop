<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:39:"template/adminblue\Goods\goodsList.html";i:1554176224;s:28:"template/adminblue\base.html";i:1554365531;s:45:"template/adminblue\controlCommonVariable.html";i:1554176224;s:32:"template/adminblue\urlModel.html";i:1554176224;s:48:"template/adminblue\Goods\goodsThreeCategory.html";i:1554176224;s:50:"template/adminblue\Goods\batchProcessingModal.html";i:1554176224;s:52:"template/adminblue\Goods\setMemberDiscountModal.html";i:1554176224;s:34:"template/adminblue\pageCommon.html";i:1554176224;s:34:"template/adminblue\openDialog.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<script type="text/javascript">
	...
	function save_goods_discount(){
		...
		if(member_discount_arr.length > 0 && goods_ids.length > 0){
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/goods/setMemberDiscount'); ?>",
				data : {
	...
	function showMemberDiscount(goods_id){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/goods/showMemberDiscountAjax'); ?>",
			data : {
				goods_id : goods_id,
			},
			success : function(data){
