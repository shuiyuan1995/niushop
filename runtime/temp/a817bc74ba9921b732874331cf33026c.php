			...
			$(function() {					
				...
				$("#pay").click(function() {
					if ($('.pay-type-list li.selected').attr("data-pay") != null) {
						...
						case "unionpay":
							//跳转到银联卡
							url = '<?php echo __URL('APP_MAIN/pay/unionpay?typeid='.$order[order_id]); ?>';
							break;
						}
						window.open(url);
