<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:42:"template/shop\blue\Member\addressList.html";i:1553151902;s:28:"template/shop\blue\base.html";i:1553151902;s:32:"template/shop\blue\urlModel.html";i:1553151902;s:34:"template/shop\blue\controlTop.html";i:1553157362;s:41:"template/shop\blue\controlHeadSerach.html";i:1553151902;s:43:"template/shop\blue\controlHeadGoodType.html";i:1553151902;s:40:"template/shop\blue\controlCommonNav.html";i:1553151902;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1553151902;s:41:"template/shop\blue\controlCommonPage.html";i:1553151902;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1553507716;s:37:"template/shop\blue\controlBottom.html";i:1553151902;s:36:"template/shop\blue\controlLogin.html";i:1553151902;s:37:"template/shop\blue\baidu_js_push.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="first active"><?php echo lang('member_receive_address_list'); ?></li>
				</ul>
			</div>
			<div class="alert alert-success">
				<h4><?php echo lang('member_operation_prompt'); ?>：</h4>
				<ul>
					<li><?php echo lang('member_operation_addresses'); ?></li>
				</ul>
			</div>
			<div class="tabmenu">
				<input type="button" value="<?php echo lang('member_new_delivery_address'); ?>" onclick="location.href='<?php echo __URL('SHOP_MAIN/member/addressinsert'); ?>'" class="main-btn common-btn" />
			</div>
			<?php if($total_count != ''): ?>
			<div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bought-table">
					<thead>
						<tr class="col-name">
							<th width="15%" style="border-left: 1px solid #E6E6E6;"><?php echo lang('member_consignee'); ?></th>
							<th width="25%"><?php echo lang('member_location'); ?></th>
							<th width="25%"><?php echo lang('member_detailed_address'); ?></th>
							<th width="15%"><?php echo lang('cell_phone_number'); ?></th>
							<th width="18%" style="border-right: 1px solid #E6E6E6;"><?php echo lang('goods_operation'); ?></th>
						</tr>
					</thead>
					<tbody class="close-order" id="list_address">
					<?php if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): $k = 0; $__LIST__ = $list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($k % 2 );++$k;?>
						<tr class="order-bd last">
							<td align="center" class="baobei no-border-right order_goods_info"><div class="last"><?php echo $new['consigner']; ?></div></td>
							<td align="center" class="baobei no-border-right order_goods_info"><div class="last"><?php echo $new['address_info']; ?></div></td>
							<td align="center" class="baobei no-border-right order_goods_info"><div class="last"><?php echo $new['address']; ?></div></td>
							<td align="center" class="baobei no-border-right order_goods_info"><div class="last"><?php echo $new['mobile']; ?></div></td>
							<td align="center" class="baobei no-border-right order_goods_info">
								<div class="last">
									<a href="<?php echo __URL('SHOP_MAIN/member/updatememberaddress','id='.$new['id']); ?>" class="main-btn main-btn-large"><?php echo lang('member_modify'); ?></a> 
									<?php if($new['is_default'] != 1): ?>
									<a href="javascript:void(0);" onclick="address_delete(<?php echo $new['id']; ?>)" class="main-btn main-btn-large"><?php echo lang('goods_delete'); ?></a>
									<?php endif; ?>
								</div>
							</td>
						</tr>
			...
			<?php else: ?>
			<div>
				<div class="emptyFrame"><i class="user_address"></i><span><?php echo lang('member_empty_address_yet'); ?></span></div>
			</div>
			<?php endif; ?>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_3546__=1;$__FOR_END_3546__=$page_count+1;for($i=$__FOR_START_3546__;$i < $__FOR_END_3546__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_15237__=1;$__FOR_END_15237__=$page_num+1;for($i=$__FOR_START_15237__;$i < $__FOR_END_15237__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_14588__=$page_count-$page_num+1;$__FOR_END_14588__=$page_count+1;for($i=$__FOR_START_14588__;$i < $__FOR_END_14588__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_30191__=$page-($page_num-1)/2;$__FOR_END_30191__=$page+($page_num-1)/2+1;for($i=$__FOR_START_30191__;$i < $__FOR_END_30191__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
function address_delete(id){
	$.ajax({
		url: "<?php echo __URL('SHOP_MAIN/member/memberaddressdelete'); ?>",
		data: { "id": id },
		type: "post",
		success: function (res) {
			if (res["code"] == 1) {
				$.msg("<?php echo lang('member_delete_successfully'); ?>!");
