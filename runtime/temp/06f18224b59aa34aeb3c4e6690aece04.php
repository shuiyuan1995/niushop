<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:50:"template/shop\blue\Member\goodsCollectionList.html";i:1553508045;s:28:"template/shop\blue\base.html";i:1553508045;s:32:"template/shop\blue\urlModel.html";i:1553508045;s:34:"template/shop\blue\controlTop.html";i:1553508045;s:41:"template/shop\blue\controlHeadSerach.html";i:1553508045;s:43:"template/shop\blue\controlHeadGoodType.html";i:1553508045;s:40:"template/shop\blue\controlCommonNav.html";i:1553508045;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1553508045;s:41:"template/shop\blue\controlCommonPage.html";i:1553508045;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1553508045;s:37:"template/shop\blue\controlBottom.html";i:1553508045;s:36:"template/shop\blue\controlLogin.html";i:1553508045;s:37:"template/shop\blue\baidu_js_push.html";i:1553508045;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab">
					<li class="first active"><?php echo lang('member_my_collection'); ?></li>
				</ul>
			</div>
			<div class="mar_top">
					...
					<tbody>
						<tr>
							<td colspan="2" class="pic-model">
								...
								<?php if($page_count == 0): ?>
									<div class="emptyFrame clearfix" style="cursor: pointer;"><i class="icon i-order"></i><span><?php echo lang('member_collect_favorite_goods'); ?></span> </div>
								<?php else: if(is_array($goods_collection_list) || $goods_collection_list instanceof \think\Collection || $goods_collection_list instanceof \think\Paginator): if( count($goods_collection_list)==0 ) : echo "" ;else: foreach($goods_collection_list as $k=>$goods): if(!(empty($goods['goods_id']) || (($goods['goods_id'] instanceof \think\Collection || $goods['goods_id'] instanceof \think\Paginator ) && $goods['goods_id']->isEmpty()))): ?>
											<li class="favorite-pic-list">
												<div class="favorite-goods-thumb">
													<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goods['goods_id']); ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>"><img src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($goods['pic_cover_mid']); ?>" alt="<?php echo $goods['goods_name']; ?>" width="200" height="200"></a>
												</div>
												<div class="favorite-goods-info">
													<dl>
														...
														<dd class="price">¥<?php echo $goods['promotion_price']; ?></dd>
														<dd class="hover_tan"  onclick="javascript:cancelCollection(<?php echo $goods['fav_id']; ?>,'goods',this);">
															<i class="guanzhu1 js-guanzhu0"></i>
															<a href="javascript:;" class="ncm-btn-mini"><?php echo lang('member_cancel'); ?></a>
														</dd>
													</dl>
												</div>
											</li>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_6396__=1;$__FOR_END_6396__=$page_count+1;for($i=$__FOR_START_6396__;$i < $__FOR_END_6396__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_21999__=1;$__FOR_END_21999__=$page_num+1;for($i=$__FOR_START_21999__;$i < $__FOR_END_21999__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_29390__=$page_count-$page_num+1;$__FOR_END_29390__=$page_count+1;for($i=$__FOR_START_29390__;$i < $__FOR_END_29390__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_3017__=$page-($page_num-1)/2;$__FOR_END_3017__=$page+($page_num-1)/2+1;for($i=$__FOR_START_3017__;$i < $__FOR_END_3017__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
function cancelCollection(fav_id, fav_type, obj) {
	$.ajax({
		...
		success : function(data) {
			$.msg("<?php echo lang('member_abolish_successful'); ?>");
