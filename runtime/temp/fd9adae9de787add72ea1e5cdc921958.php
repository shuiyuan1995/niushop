<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:39:"template/shop\blue\Goods\goodsInfo.html";i:1554176224;s:28:"template/shop\blue\base.html";i:1554176224;s:32:"template/shop\blue\urlModel.html";i:1554176224;s:34:"template/shop\blue\controlTop.html";i:1554176224;s:41:"template/shop\blue\controlHeadSerach.html";i:1554176224;s:43:"template/shop\blue\controlHeadGoodType.html";i:1554176224;s:40:"template/shop\blue\controlCommonNav.html";i:1554176224;s:43:"template/shop\blue\controlRightSidebar.html";i:1554176224;s:44:"template/shop\blue\Goods\controlGallery.html";i:1554176224;s:42:"template/shop\blue\Goods\controlVideo.html";i:1554176224;s:46:"template/shop\blue\Goods\controlStoreRank.html";i:1554176224;s:49:"template/shop\blue\Goods\controlGoodEvaluate.html";i:1554176224;s:45:"template/shop\blue\controlCommonPageAjax.html";i:1554176224;s:55:"template/shop\blue\Goods\controlPurchaseConsulting.html";i:1554176224;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1554176224;s:50:"template/shop\blue\Goods\controlGoodsInfoData.html";i:1554176224;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1554176224;s:37:"template/shop\blue\controlBottom.html";i:1554176224;s:36:"template/shop\blue\controlLogin.html";i:1554176224;s:37:"template/shop\blue\baidu_js_push.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<?php endif; if($goods_info['give_point'] != 0): ?>
					<div class="realy-price">
						<div class="now-prices">
							...
							<strong class="p-price second-color" style="font-size:12px;line-height:30px;padding: 1px 5px;color: #fff;margin-left: 5px;background-color: #E31939;"><span id="give_point"><?php echo $goods_info['give_point']; ?></span>&nbsp;<?php echo lang('points'); ?></strong>
						</div>
					</div>
				<?php endif; ?>
				<input type="hidden" id="hidden_give_point" value="<?php echo $goods_info['give_point']; ?>">
				<input type="hidden" id="integral_give_type" value="<?php echo $goods_info['integral_give_type']; ?>">
				
				<?php if($goods_info['point_exchange_type'] == 2): ?>
					<div class="realy-price">
						<div class="now-prices">
...
<!-- 						<li class="last"><p><?php echo lang('goods_gift_points'); ?><span class="color"><?php echo $goods_info['give_point']; ?></span></p></li> -->
			...
			<div class="choose js-skulist">
				...
				<input type="hidden" id="goods_sku<?php echo $k; ?>" value="<?php echo $pro_skus['attr_value_items']; ?>;" stock="<?php echo $pro_skus['stock']; ?>" <?php if($pro_skus['promote_price'] < $pro_skus['member_price']): ?>price="<?php echo $pro_skus['promote_price']; ?>" <?php else: ?>price="<?php echo $pro_skus['member_price']; ?>"<?php endif; ?> promotion_price="<?php echo $pro_skus['promote_price']; ?>" member_price="<?php echo $pro_skus['member_price']; ?>" skuid="<?php echo $pro_skus['sku_id']; ?>" skuname="<?php echo $pro_skus['sku_name']; ?>" original_price="<?php echo $pro_skus['market_price']; ?>" Js-sku="sku"/>
...
<div id="goods_evaluate" class="goods-detail-con goods-detail-tabs" name="goods_evaluate">
	...
	<div class="page-wrap fr">
		...
		<input type="hidden" id="pagesize" name="pagesize" value="14"/>
		</div>
	</div>
