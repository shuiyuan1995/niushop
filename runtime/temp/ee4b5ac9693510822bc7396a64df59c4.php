<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:47:"template/wap\default_new\Goods\goodsDetail.html";i:1553151902;s:34:"template/wap\default_new\base.html";i:1553151902;s:38:"template/wap\default_new\urlModel.html";i:1553151903;s:49:"template/wap\default_new\Goods\controlDetail.html";i:1553151902;s:55:"template/wap\default_new\Goods\controlGoodEvaluate.html";i:1553151902;s:46:"template/wap\default_new\controlCopyRight.html";i:1553151902;s:53:"template/wap\default_new\Goods\controlPhotoSwipe.html";i:1553151902;s:57:"template/wap\default_new\Goods\controlSkuSelectEvent.html";i:1553151902;s:43:"template/wap\default_new\shareContents.html";i:1553151903;s:35:"template/wap\default_new\share.html";i:1553151903;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
#store_service img{width:20px;height:20px;margin-right:5px;}
#shop_service img{width: 22px;height: 23px;margin-right: 10px;padding-left: 1px;}
#shop_service span{color:#051b28;}
.goods-unit-style{color: #F44;font-size: 20px;display: inline-block;font-weight: normal;}
</style>
...
<div class="buy_area">
	...
	<?php if($goods_detail['promotion_price'] <= $goods_detail['member_price']): if($goods_detail['market_price'] > 0 && $goods_detail['market_price'] != $goods_detail['promotion_price']): ?>
		<div class="price_wrap">	
			<span class="price" price="<?php echo $goods_detail['market_price']; ?>">			
				<span style="font-size:14px;display: inline-block;vertical-align: middle;text-decoration: line-through;color:#999;">市场价：￥<?php echo $goods_detail['market_price']; ?></span>	
			</span>
		</div>
		<?php endif; else: if($goods_detail['market_price'] > 0 && $goods_detail['market_price'] != $goods_detail['member_price']): ?>
		<div class="price_wrap">	
			<span class="price" price="<?php echo $goods_detail['market_price']; ?>">			
				<span style="font-size:14px;display: inline-block;vertical-align: middle;text-decoration: line-through;color:#999;">市场价：￥<?php echo $goods_detail['market_price']; ?></span>	
			</span>
...
<div class="price_postage" id = "manjian_preferential">
	<span class="js-reduced-send single"><i style="color: #fff;font-size: 12px;padding: 1px 3px;background: #f44;border-radius: 2px;"><?php echo lang('member_full'); ?><?php echo lang('member_reduce'); ?></i>&nbsp;<?php echo $goods_detail['mansong_name']; ?><i class="jiantou"></i></span>
...
<div class="price_postage">
	...
	<span style="padding-left: 5px;">
		<?php if($goods_detail['presell_delivery_type'] == 1): ?>
			<?php echo getTimeStampTurnTime($goods_detail['presell_time']); ?>天发货
		<?php else: ?>
			付款<?php echo $goods_detail['presell_day']; ?>天后发货
		<?php endif; ?>
	</span>
</div>
<hr class="with-margin-l">
	...
	<div class="evaluation-container">
		...
		<div class="evaluation-comments">
			...
			<div class="evaluation-userinfo">
				...
				<img src="<?php echo __IMG($goodsEvaluation['user_img']); ?>" alt="" data-origina="<?php echo $goodsEvaluation['user_img']; ?>" class="headimg lazy_load">
				<?php else: ?>
...
<hr class="divider-line">
<div class="price_postage" id="goods-attribute">
	<span class="price_postage_tit single"><?php echo lang('goods_commodity_attribute'); ?><i class="jiantou"></i></span>
</div>
<?php endif; ?>
	...
	<ul class="s-buy-ul specification" id="specification" style="z-index: 9000;">
		...
		<li class="s-buy-li JS-spec" >
			...
			<?php if(is_array($spec['value']) || $spec['value'] instanceof \think\Collection || $spec['value'] instanceof \think\Paginator): if( count($spec['value'])==0 ) : echo "" ;else: foreach($spec['value'] as $child_k=>$spec_value): if($spec_value['spec_id'] == $spec['spec_id']): ?>
					<button class="select" name="Span<?php echo $k; ?>" id="<?php echo $spec_value['spec_id']; ?>:<?php echo $spec_value['spec_value_id']; ?>" data-picture-id="<?php echo $spec_value['picture']; ?>"><?php echo $spec_value['spec_value_name']; ?></button>
				<?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</li>
		<hr class="with-margin-l" />
...
<!--满减送信息弹出框 -->
<div class="bottom_popup"  data-popup-type="manjian_preferential">
	<div class="bottom_popup_title">
		<?php echo lang('member_full'); ?><?php echo lang('member_reduce'); ?>
	</div>
	<ul class="coupon_list">
		<mark class="mark_title"><?php echo lang('member_full'); ?><?php echo lang('member_reduce'); ?></mark>
		<span class="js-reduced-send">&nbsp;<?php echo $goods_detail['mansong_name']; ?></span>
	</ul>
	<div class="bottom_popup_button"> 
		<span>完成</span>
	</div>
	...
	<ul class="coupon_list" id="shop_service">
		<?php if(!(empty($existingMerchant) || (($existingMerchant instanceof \think\Collection || $existingMerchant instanceof \think\Paginator ) && $existingMerchant->isEmpty()))): if(is_array($existingMerchant) || $existingMerchant instanceof \think\Collection || $existingMerchant instanceof \think\Paginator): if( count($existingMerchant)==0 ) : echo "" ;else: foreach($existingMerchant as $key=>$vo): ?>
			<li>
				...
				<?php else: ?>
				<img src="<?php echo __IMG($vo['pic']); ?>"/><span><?php echo $vo['title']; ?></span>
				<?php endif; ?>
...
<!-- 商品属性 -->
<div class="bottom_popup"  data-popup-type="goods-attribute">
	<div class="bottom_popup_title">
		<?php echo lang('goods_commodity_attribute'); ?>
	</div>
	<ul class="coupon_list" style="height:290px">
...
$(".goods-alter span").each(function(i){
	...
	<?php if(!(empty($goods_detail['goods_video_address']) || (($goods_detail['goods_video_address'] instanceof \think\Collection || $goods_detail['goods_video_address'] instanceof \think\Paginator ) && $goods_detail['goods_video_address']->isEmpty()))): ?>
		video_url = "<?php echo __IMG($goods_detail['goods_video_address']); ?>";
	<?php endif; ?>
	$(this).click(function(){
...
$("#manjian_preferential").click(function(){
		$("body").css({ overflow : "hidden"});
		$("#mask").show();
		$(".bottom_popup[data-popup-type='manjian_preferential']").slideDown(300);
	})
