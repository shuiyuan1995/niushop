<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Upgrade\onlineUpdate.html";i:1554176224;s:28:"template/adminblue\base.html";i:1554365531;s:45:"template/adminblue\controlCommonVariable.html";i:1554176224;s:32:"template/adminblue\urlModel.html";i:1554176224;s:34:"template/adminblue\pageCommon.html";i:1554176224;s:34:"template/adminblue\openDialog.html";i:1554176224;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<span class="right">
					<?php if($result != ''): ?>
						<?php echo $devolution_code; ?> &nbsp;&nbsp;<a href="javascript:;" target="_blank" onclick="bind()" class="btn_bind">重新绑定</a>
					<?php else: ?>
					<a href="javascript:;" target="_blank"  onclick="bind()" class="btn_bind">立即绑定</a>
					<a href="http://www.niushop.com.cn/authorization.html" target="_blank" class="btn_bind">去授权</a>
					<?php endif; ?>
					</span>
					</td>
				</tr>
				<tr><td>站点URL：<span class="right" style="margin-left: 14px;"><?php echo $result['data']['devolution_url']; ?></span></td></tr>
				...
				<?php if(!(empty($result['data']['devolution_obj']['devolution_date']) || (($result['data']['devolution_obj']['devolution_date'] instanceof \think\Collection || $result['data']['devolution_obj']['devolution_date'] instanceof \think\Paginator ) && $result['data']['devolution_obj']['devolution_date']->isEmpty()))): ?>
		        	<?php echo getTimeStampTurnTimeByYmd($result['data']['devolution_obj']['devolution_date']); endif; ?></span></td></tr>
				<tr><td >当前版本：<span class="back-color color_2"><?php echo $niu_version; ?></span></td></tr>
				<tr><td >最新版本：<span class="back-color color_1">V<?php echo $latestVersion['data']['latest_version']; ?></span></td></tr>
				
				<?php if($result['code'] == 0): ?>
					<tr>
						<td>
						授权版本：<span class="back-color color_3"><?php echo $result['data']['devolution_version_name']; ?></span>
						<?php if(is_array($result['data']['devolution_module']) || $result['data']['devolution_module'] instanceof \think\Collection || $result['data']['devolution_module'] instanceof \think\Paginator): $i = 0; $__LIST__ = $result['data']['devolution_module'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<span class="back-color color_3"><?php echo $vo['devolution_momdel_name']; ?></span>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</td>
					</tr>
