    ...
    public function init()
    {
        ...
        if ($check_auth) {
            ...
            if (! request()->isAjax()) {
                ...
                if(empty($_SESSION['UEDITOR_UPLOAD_HANDLE_URL'])){
                    $_SESSION['UEDITOR_UPLOAD_HANDLE_URL'] = __URL(\think\Config::get('view_replace_str.APP_MAIN') . "/upload/ueditorUploadQiNiu");
                }else{
                    if($_SESSION['UEDITOR_UPLOAD_HANDLE_URL'] !=  __URL(\think\Config::get('view_replace_str.APP_MAIN') . "/upload/ueditorUploadQiNiu")){
                        $_SESSION['UEDITOR_UPLOAD_HANDLE_URL'] = __URL(\think\Config::get('view_replace_str.APP_MAIN') . "/upload/ueditorUploadQiNiu");
                    }
                }
            }
