...
class System extends BaseController
{
    ...
    public function dialogAlbumList()
    {
        ...
        $upload_path = request()->get("upload_path",UPLOADCOMMON);
    ...
    public function albumPictureList()
    {
        ...
        if (request()->isAjax()) {
            ...
            if($picture_sort > 0){
                switch ($picture_sort) {
                    case 1:
                        $order = "upload_time desc,pic_name desc";
                        break;
                    case 2:
                        $order = "upload_time asc,pic_name desc";
                        break;
                    case 3:
                        $order = "pic_name desc,upload_time desc";
                        break;
                    case 4:
                        $order = "pic_name asc,upload_time desc";
                        break;
                }
            }
