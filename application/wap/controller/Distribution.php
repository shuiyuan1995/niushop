...
//         ]);
    ...
    {
        $nfx_promoter = new NfxPromoter();
        $promoter_id = isset($_GET["promoter_id"]) ? $_GET["promoter_id"] : "";
    ...
    public function userAccountRecordsDetail()
    {
        ...
        $condition['shop_id'] = isset($_GET['shop_id']) ? $_GET['shop_id'] : "";
    ...
    {
        $type_alis_id = isset($_GET['type_alis_id']) ? $_GET['type_alis_id'] : '1';
    ...
    public function toWithdraw()
    {
        ...
        if (request()->isAjax()) {
            ...
            $bank_account_id = isset($_POST['bank_account_id']) ? $_POST['bank_account_id'] : '';
